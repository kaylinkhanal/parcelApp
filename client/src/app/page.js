          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-col text-center w-full mb-20">
              ...
              <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                So much goes into running your business. Take some time to
                recharge and read. Get guidance on everything from creating a
                returns strategy to improving sustainability.
              </p>
            </div>
